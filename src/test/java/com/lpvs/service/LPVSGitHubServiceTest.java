    ...
    class TestCommentResults__ProhibitedAbsentConflictsAbsent {
        ...
        final String expected_comment =
                "**\\[LPVS\\]**  No license issue detected \n\n"
                        ...
                        + "<summary>Detailed description of detected licenses\n"
                        + "</summary>\n"
                        + "<table><thead><tr><th>License Type / Explanation</th><th>License SPDX ID</th><th>Vendor / Component</th><th>Repository File Path</th><th>Component Version</th><th>Component File Path</th><th>Matched Lines</th><th>Match Value</th></tr></thead><tbody><tr><td rowspan=\"1\"><span style=\"color: green; font-weight: bold;\">PERMITTED</span> / This license permits free usage, modification, and distribution of the licensed code without any restrictions.</td><td rowspan=\"1\">MIT</td><td rowspan=\"1\">null / LPVS::Services</td><td rowspan=\"1\">src/main/java/com/lpvs/service/LPVSGitHubService.java</td><td>null</td><td>src/main/java/com/lpvs/service/LPVSGitHubService.java</td><td><a target=\"_blank\" href=\"https://github.com/Samsung/LPVS/blob/895337e89ae103ff2d18c9e0d93709f743226afa/src/main/java/com/lpvs/service/LPVSGitHubService.java#L1L6\">1-6</a>  </td><td>10%</td></tr></tbody></table>\n"
                        + "</details>\n"
                        + "\n"
                        + "**Detected License Conflicts:**\n"
                        + "\n"
