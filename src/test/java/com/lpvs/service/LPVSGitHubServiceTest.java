    ...
    class TestCommentResults__ProhibitedPresentConflictsPresent {
        ...
        final String expected_comment =
                "**\\[LPVS\\]** Potential license issues detected \n\n"
                        ...
                        + "</summary>\n"
                        + "<table><tr><th>License Type / Explanation</th><th>License SPDX ID</th><th>Vendor / Component</th><th>Repository File Path</th><th>Component Version</th><th>Component File Path</th><th>Matched Lines</th><th>Match Value</th><tr><tr><td rowspan=\"1\"><span style=\"color: red; font-weight: bold;\">PROHIBITED</span> / This license prohibits the use of the licensed code in certain contexts, such as commercial software development.</td><td rowspan=\"1\">MIT</td><td rowspan=\"1\">null / LPVS::Services</td><td rowspan=\"1\">src/main/java/com/lpvs/service/LPVSGitHubService.java</td><td><a href=\"null\">null</a></td><td><a href=\"src/main/java/com/lpvs/service/LPVSGitHubService.java\">src/main/java/com/lpvs/service/LPVSGitHubService.java</a></td><td><a target=\"_blank\" href=\"https://github.com/Samsung/LPVS/blob/895337e89ae103ff2d18c9e0d93709f743226afa/src/main/java/com/lpvs/service/LPVSGitHubService.java#L1L6\">1-6</a>  </td><td>15%</td></tr></table>\n"
                        + "</details>\n"
                        + "\n"
    ...
    class TestCommentResults__EmptyPresentConflictsPresent {
        ...
        final String expected_comment =
                "**\\[LPVS\\]** Potential license issues detected \n\n"
                        ...
                        + "<summary>Detailed description of detected licenses\n"
                        + "</summary>\n"
                        + "<table><tr><th>License Type / Explanation</th><th>License SPDX ID</th><th>Vendor / Component</th><th>Repository File Path</th><th>Component Version</th><th>Component File Path</th><th>Matched Lines</th><th>Match Value</th><tr><tr><td rowspan=\"1\"><span style=\"color: green; font-weight: bold;\">PERMITTED</span> / This license permits free usage, modification, and distribution of the licensed code without any restrictions.</td><td rowspan=\"1\">MIT</td><td rowspan=\"1\">vendor1 / LPVS::Services</td><td rowspan=\"1\">src/main/java/com/lpvs/service/LPVSGitHubService.java</td><td><a href=\"http://component/url\">version_1</a></td><td><a href=\"src/main/java/com/lpvs/service/LPVSGitHubService.java\">src/main/java/com/lpvs/service/LPVSGitHubService.java</a></td><td><a target=\"_blank\" href=\"https://github.com/Samsung/LPVS/blob/895337e89ae103ff2d18c9e0d93709f743226afa/src/main/java/com/lpvs/service/LPVSGitHubService.java#L1L6\">1-6</a>  </td><td>30%</td></tr></table>\n"
                        + "</details>\n"
                        + "\n"
                        + "**Detected License Conflicts:**\n"
                        + "\n"
    ...
    class TestCommentResults__UnreviewedPresentConflictsPresent {
        ...
        final String expected_comment =
                "**\\[LPVS\\]** Potential license issues detected \n\n"
                        ...
                        + "<summary>Detailed description of detected licenses\n"
                        + "</summary>\n"
                        + "<table><tr><th>License Type / Explanation</th><th>License SPDX ID</th><th>Vendor / Component</th><th>Repository File Path</th><th>Component Version</th><th>Component File Path</th><th>Matched Lines</th><th>Match Value</th><tr><tr><td rowspan=\"1\"><span style=\"color: orange; font-weight: bold;\">UNREVIEWED</span> / This license has not been reviewed thoroughly and may contain unknown risks or limitations. It is recommended to review these licenses carefully before using the licensed code.</td><td rowspan=\"1\">MIT</td><td rowspan=\"1\">null / LPVS::Services</td><td rowspan=\"1\">src/main/java/com/lpvs/service/LPVSGitHubService.java</td><td><a href=\"null\">null</a></td><td><a href=\"src/main/java/com/lpvs/service/LPVSGitHubService.java\">src/main/java/com/lpvs/service/LPVSGitHubService.java</a></td><td><a target=\"_blank\" href=\"https://github.com/Samsung/LPVS/blob/895337e89ae103ff2d18c9e0d93709f743226afa/src/main/java/com/lpvs/service/LPVSGitHubService.java#L1L6\">1-6</a>  </td><td>50%</td></tr></table>\n"
                        + "</details>\n"
                        + "\n"
                        + "**Detected License Conflicts:**\n"
                        + "\n"
    ...
    class TestCommentResults__RestrictedPresentConflictsPresent {
        ...
        final String expected_comment =
                "**\\[LPVS\\]** Potential license issues detected \n\n"
                        ...
                        + "<summary>Detailed description of detected licenses\n"
                        + "</summary>\n"
                        + "<table><tr><th>License Type / Explanation</th><th>License SPDX ID</th><th>Vendor / Component</th><th>Repository File Path</th><th>Component Version</th><th>Component File Path</th><th>Matched Lines</th><th>Match Value</th><tr><tr><td rowspan=\"1\"><span style=\"color: orange; font-weight: bold;\">RESTRICTED</span> / This license required compliance with specific obligations. It is crucial to carefully review and adhere to these obligations before using the licensed code.</td><td rowspan=\"1\">MIT</td><td rowspan=\"1\">null / LPVS::Services</td><td rowspan=\"1\">src/main/java/com/lpvs/service/LPVSGitHubService.java</td><td><a href=\"null\">null</a></td><td><a href=\"src/main/java/com/lpvs/service/LPVSGitHubService.java\">src/main/java/com/lpvs/service/LPVSGitHubService.java</a></td><td><a target=\"_blank\" href=\"https://github.com/Samsung/LPVS/blob/895337e89ae103ff2d18c9e0d93709f743226afa/src/main/java/com/lpvs/service/LPVSGitHubService.java#L1L6\">1-6</a>  </td><td>40%</td></tr></table>\n"
                        + "</details>\n"
                        + "\n"
                        + "**Detected License Conflicts:**\n"
                        + "\n"
    ...
    class TestCommentResults__ProhibitedAbsentConflictsAbsent {
        ...
        final String expected_comment =
                "**\\[LPVS\\]**  No license issue detected \n\n"
                        ...
                        + "<summary>Detailed description of detected licenses\n"
                        + "</summary>\n"
                        + "<table><tr><th>License Type / Explanation</th><th>License SPDX ID</th><th>Vendor / Component</th><th>Repository File Path</th><th>Component Version</th><th>Component File Path</th><th>Matched Lines</th><th>Match Value</th><tr><tr><td rowspan=\"1\"><span style=\"color: green; font-weight: bold;\">PERMITTED</span> / This license permits free usage, modification, and distribution of the licensed code without any restrictions.</td><td rowspan=\"1\">MIT</td><td rowspan=\"1\">null / LPVS::Services</td><td rowspan=\"1\">src/main/java/com/lpvs/service/LPVSGitHubService.java</td><td><a href=\"null\">null</a></td><td><a href=\"src/main/java/com/lpvs/service/LPVSGitHubService.java\">src/main/java/com/lpvs/service/LPVSGitHubService.java</a></td><td><a target=\"_blank\" href=\"https://github.com/Samsung/LPVS/blob/895337e89ae103ff2d18c9e0d93709f743226afa/src/main/java/com/lpvs/service/LPVSGitHubService.java#L1L6\">1-6</a>  </td><td>10%</td></tr></table>\n"
                        + "</details>\n"
                        + "\n"
                        + "**Detected License Conflicts:**\n"
                        + "\n"
